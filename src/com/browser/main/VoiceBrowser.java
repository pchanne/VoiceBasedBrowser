...
public class VoiceBrowser extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		ToolbarView.getAddBookmarkButton().setOnAction(
				new EventHandler<ActionEvent>() {

					public void handle(ActionEvent arg0) {
						// TODO Auto-generated method stub
						// get link in address bar and set it to url label of
						// bookmark pop window
						...
						ToolbarView.setBookmarkTitleText(browserWindow
								.getView().getEngine().getTitle());
						ToolbarView.setBookmarkUrlText(addressBarField
								.getText());
		...
		ToolbarView.getAddBookmarkToModelButton().setOnAction(
				new EventHandler<ActionEvent>() {
