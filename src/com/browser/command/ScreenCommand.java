...
public class ScreenCommand implements Command{
	...
	@Override
	public void execute() {
		TabView.getCurrentViewController().getTagHandler().initialiseViews(0, 0, TabView.getCurrentViewController().getBrowserWindowView().browser.getWidth(), TabView.getCurrentViewController().getBrowserWindowView().browser.getHeight());
		int startX = 0;
		int startY = 0;
