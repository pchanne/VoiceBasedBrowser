...
/**
 * This command class represents the functionality to display all the paragraphs of the selected view.
 */
...
public class TextCommand implements Command{
	...
	public void execute() {
		...
		TabView.getCurrentViewController().getTagHandler().highlightAllTextinCurrentView();
	}
