...
/**
 *  This command class represents the functionality to read the title within the selected view.
 */
...
public class ReadCommand implements Command{
	...
	public void execute() {
		...
		System.out.println("restarted");
			SpeechHelper.speechReaderTask.restart(); //restarts the reader task.
	}
