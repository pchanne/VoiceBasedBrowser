...
/**
 * This command class represents the functionality to display all the links of the selected view.
 */
...
public class LinksCommand implements Command{
	...
	public void execute() {
		...
		TabView.getCurrentViewController().getTagHandler().highlightAllLinksinCurrentView();
	}
